            ...
            <div className="inner">
                ...
                <div className="content">
                    <div className="content-left">
                        <h5 className="title">
                            <Link to={process.env.PUBLIC_URL + `/login-register`}>{data.title}</Link>
                        </h5>
                    ...
                    <div className="read-more-btn">
                        <Link className="edu-btn btn-dark" to={process.env.PUBLIC_URL + `/login-register`}>Book A Seat<i className="icon-arrow-right-line-right"></i></Link>
                    </div>
                </div>
            </div>
        </div>
